...
const SideBardCurrencyConverter = ({ currencyfrom, currencyto, currency }) => {
  ...
  const base_url = "https://api.exchangerate.fun/latest?"; // This API is better as it have more countries currency
  ...
  const fetchData = async () => {
    try {
      ...
      // update Exchange Rate data in useState
  ...
  // Toggle between from and to amount
  ...
  // Get value from input and toggle the from and to amount 
